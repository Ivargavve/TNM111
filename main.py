...
# Define a class representing a point in the scatter plot
class Point:
...
class ScatterPlot:
    ...
    def draw_points(self, x_range, y_range, types):
        ...
        for point in self.data:
            ...
            # Bind left-click and right-click events to the canvas elements
    ...
    # Handle left-click event on a canvas element
    ...
    # Handle right-click event on a canvas element
